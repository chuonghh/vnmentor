<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="employeesListDayOff.aspx.cs" Inherits="admin_employeesListDayOff" %>
            ...
            <Columns>
                  ...
                  <HeaderStyle BackColor="White" VerticalAlign="Middle" />
                   ...
                   <dx:GridViewDataButtonEditColumn Caption="" VisibleIndex="1"  Width="70px">
                    <DataItemTemplate> 
                                       <dx:ASPxButton ID="btn_update" runat="server" AutoPostBack="true" style="float: right" CssPostfix="Aqua"  OnClick="btn_update_Click" ToolTip="Chỉnh sữa nhân viên">
                                           <Image IconID="iconbuilder_actions_edit_svg_16x16"  >
                                           </Image>
                                       </dx:ASPxButton> 
                                 
                                       <dx:ASPxButton ID="btn_popup_delete" runat="server" AutoPostBack="true"  style="float: left; margin-right: 5px" CssPostfix="Aqua" OnClick="btn_popup_delete_Click" ClientEnabled="true"  ToolTip="Mở lại nhân viên">
                                           <Image IconID="iconbuilder_security_unlock_svg_gray_16x16">
                                           </Image>
                                       </dx:ASPxButton>
                                   </div> 
                    </DataItemTemplate>
...
<dx:ASPxPopupControl ID="popup_Notification" runat="server" CloseAction="CloseButton" CloseOnEscape="true" Modal="True"
 ...
 <asp:Label ID="lbl_popup_title" runat="server" CssClass="black_16_b"></asp:Label>
            ...
            <dx:ASPxButton ID="btn_delete" runat="server" Text="Mở"  AutoPostBack="true" style="float: right; margin-right: -11px;Width:140px"  Theme="Material"     CausesValidation="false" OnClick="btn_delete_Click" >
                                               <%-- <ClientSideEvents Click="function(s, e) { popup_Notification.Hide(); }" />--%>
                                            </dx:ASPxButton>
                                       </div>  
