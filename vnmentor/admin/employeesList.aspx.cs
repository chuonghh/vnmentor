...
public partial class admin_employeesList : System.Web.UI.Page
{
    ...
    DataTable GetTable()
    {
        ...
        { 
            table = new DataTable();
            table = emp_Ctrl.employeesGet_depCode_comCode_active_dt(cb_comCode.Value.ToString(), cb_depCode.Value.ToString(), "1"); 
        }
        return table;
    ...
    protected string DocumentsFolder = "~/admin/dataFile/exportData/";
    ...
    {
        //string DocumentsFolder = @"C:\Users\Public\Public Downloads\exportEmployees\";

        if (Directory.Exists(Server.MapPath("~") + DocumentsFolder))
            Directory.CreateDirectory(DocumentsFolder);
        string JoinDate = DateTime.Now.ToString("yyyyMMdd");
        string JoinTime = DateTime.Now.ToString("HH") + "h" + DateTime.Now.ToString("mm");
        DocumentFileName = "exportData" + "_" + JoinDate + "_" + JoinTime;
        ...
        exportFilePath =  DocumentsFolder + DocumentFileName   + "." + format;
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("Content-Disposition", "attachment; filename=" + DocumentFileName + ".xlsx");
        Response.TransmitFile(Server.MapPath(DocumentsFolder + DocumentFileName + ".xlsx"));
        Response.End();
    }
    protected void btn_export_xls_Click(object sender, EventArgs e)
    {
        SaveFile(actionToCall => Exporter.WriteXlsx(actionToCall), "xls");
    }

    protected void btn_export_pdf_Click(object sender, EventArgs e)
    {
        SaveFile(actionToCall => Exporter.WriteXlsx(actionToCall), "pdf");
    }
