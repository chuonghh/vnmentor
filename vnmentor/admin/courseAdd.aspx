...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <dx:ASPxTextBox ID="txt_couCode" runat="server" Width="120px" Theme="Material"   CssClass="black_14_b" ReadOnly="True" TabIndex="3">
...
<%--    <div class="col-lg-12 margin-bottom" > 
    ...
    <div class="col-lg-10 no-padding" > 
        <dx:BootstrapTagBox runat="server" ID="txt_tags" AllowCustomTags="true" >
        </dx:BootstrapTagBox>
