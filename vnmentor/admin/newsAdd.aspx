...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
         function UpdateInfo() {
          ...
          <Triggers > 
              <asp:AsyncPostBackTrigger ControlID="cb_menu" />
            <asp:PostBackTrigger ControlID="popup_Notification"/>  
               <asp:PostBackTrigger ControlID="btn_submit"  ></asp:PostBackTrigger>
                  </Triggers>
             <ContentTemplate> 
          <div class="col-lg-12 margin-bottom" > 
      <div class="col-lg-2 pad-top-4" > <dx:ASPxLabel ID="lbl_empCode" runat="server" Text="Mã tin :"></dx:ASPxLabel></div> 
    ...
    <dx:ASPxComboBox ID="cb_menu" runat="server" Theme="Material"  EnableCallbackMode="true" CallbackPageSize="10"
    ...
    <div class="col-lg-10 no-padding" >  
         <dx:ASPxComboBox ID="cb_menu1" runat="server" Theme="Material"  EnableCallbackMode="true" CallbackPageSize="10"
                ValueType="System.String" ValueField="menCode"
              TextFormatString="{0} {1} {2}"
    ...
    <dx:ASPxTextBox ID="txt_newName" runat="server" Width="100%" Theme="Material" TabIndex="4">
    ...
    <div class="col-lg-10 no-padding" >  
          ...
          <div class="col-lg-5 no-padding">
           ...
           <dx:ASPxDataView ID="dataView" runat="server" EnableTheming="True" Theme="Material"> 
            
             
               <ItemTemplate>
            <table style="margin: 0 auto;">
                <tr>
                    <td colspan="2"><a href="admin.master">admin.master</a>
                        <dx:ASPxImage ID="ASPxImage1" runat="server" ShowLoadingImage="true"  ImageUrl='<%#Eval("PhotoUrl")%>' Width="200px" Height="200px" ></dx:ASPxImage>
    ...
    <div class="col-lg-10 no-padding" > 
  <dx:ASPxHtmlEditor ID="txt_description" runat="server" Theme="Material"  Width="100%" Height="700px" TabIndex="5">
      ...
      <SettingsDialogs>
       ...
       <div class="col-lg-12 margin-bottom" > 
      <div class="col-lg-2 pad-top-4" > <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text="Nguồn hoặc tác giả"></dx:ASPxLabel></div> 
    <div class="col-lg-10 no-padding" > 
    <dx:ASPxTextBox ID="txt_source" runat="server" Width="100%" Theme="Material" TabIndex="6" style="float: left">  
                     <InvalidStyle BackColor="#FFD2D9" />
                 <Border BorderColor="#009688" BorderStyle="Solid" BorderWidth="1px" />
    </dx:ASPxTextBox>
