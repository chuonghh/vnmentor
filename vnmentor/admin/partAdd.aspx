<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="partAdd.aspx.cs" Inherits="admin_partAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
         function UpdateInfo() {
          ...
          <Triggers > 
              <asp:AsyncPostBackTrigger ControlID="cb_partGroup" />
    ...
    <dx:ASPxComboBox ID="cb_partGroup" runat="server" Theme="Material"  EnableCallbackMode="true" CallbackPageSize="10"
                ValueType="System.String" ValueField="partGroupCode"
              TextFormatString="{0} {1} {2}"
                Width="250px" DropDownStyle="DropDown" TabIndex="1" OnSelectedIndexChanged="cb_partGroup_SelectedIndexChanged" AutoPostBack="true"> 
    ...
    <div class="col-lg-10 no-padding" >  
         <dx:ASPxComboBox ID="cb_partGroup1" runat="server" Theme="Material"  EnableCallbackMode="true" CallbackPageSize="10"
                ValueType="System.String" ValueField="depCode"
              TextFormatString="{0} {1} {2}"
                Width="250px" DropDownStyle="DropDown" TabIndex="2"> 
         <Border BorderColor="#009688" BorderStyle="Solid" BorderWidth="1px" />
        </dx:ASPxComboBox>
    </div>
        </div>
      <div class="col-lg-12 margin-bottom" > 
      <div class="col-lg-2 pad-top-4" > <dx:ASPxLabel ID="lbl_empCode" runat="server" Text="Mã sản phẩm :"></dx:ASPxLabel></div> 
    <div class="col-lg-10 no-padding" data-bind="txt_empCode: { editEnabled: false  }"> 
   
    <dx:ASPxTextBox ID="txt_partCode" runat="server" Width="250px" Theme="Material"   CssClass="black_14_b" TabIndex="3">
    ...
    <div class="col-lg-12 margin-bottom" > 
      <div class="col-lg-2 pad-top-4" > <dx:ASPxLabel ID="lbl_empName" runat="server" Text="Tên sản phẩm :"></dx:ASPxLabel></div> 
    <div class="col-lg-10 no-padding" > 
      
    <dx:ASPxTextBox ID="txt_partName" runat="server" Width="100%" Theme="Material" TabIndex="4">
    ...
    <div class="col-lg-10 no-padding" > 
  <dx:ASPxHtmlEditor ID="txt_proDescription" runat="server" Theme="Material"  Width="100%" Height="400px" TabIndex="5">
      ...
      <SettingsDialogs>
            <InsertImageDialog ShowStyleSettingsSection="true">
                ...
                <SettingsImageUpload UploadFolder="~/admin/images/upload/product/" AdvancedUploadModeTemporaryFolder="~\admin\images\upload\uploadTemp\">
       ...
       <div class="col-lg-12 margin-bottom" > 
      <div class="col-lg-2 pad-top-4" > <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text="Giá sản phẩm:"></dx:ASPxLabel></div> 
    <div class="col-lg-10 no-padding" > 
    <dx:ASPxTextBox ID="txt_priceSell" runat="server" Width="250px" Theme="Material" TabIndex="6" style="float: left"> <MaskSettings Mask="&lt;0..9999999999g&gt;" />
        ...
        <asp:Label ID="Label1" runat="server" Text="VNĐ" style="float: left; position:absolute; top :5px; left:215px; color:red; font-weight:bold" ></asp:Label>
                 ...
                 <div class="col-lg-12 margin-bottom" > 
    <div class="col-lg-2 pad-top-4" > <dx:ASPxLabel ID="ASPxLabel17" runat="server" Text="Màu sản phẩm :"></dx:ASPxLabel></div> 
    <div class="col-lg-10 no-padding" > 
   <dx:ASPxColorEdit runat="server" ID="txt_color" Color="#f7f7f7" Width="250px" ClearButton-DisplayMode="Never" Theme="Material" ValidationSettings-CausesValidation="false" TabIndex="7">
    ...
    <div class="col-lg-10 no-padding" > 
             ...
             <dx:ASPxUploadControl ID="UploadControl" runat="server" ClientInstanceName="UploadControl" Width="50%"
            NullText="Select multiple files..." UploadMode="Advanced" ShowUploadButton="True" ShowProgressPanel="True"
            OnFileUploadComplete="UploadControl_FileUploadComplete" Theme="Material">
