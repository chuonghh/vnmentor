...
public partial class admin_employeesAdd : System.Web.UI.Page
{
    ...
    const string UploadDirectory = "/admin/images/uploadTemp/employees/";
    ...
    protected void employeesAdd()
    {
        try
        {
            string pathServer = "/admin/images/upload/employees/" + locdau.Locdau_TiengViet(cb_comCode.Text) + "/" + locdau.Locdau_TiengViet(cb_depCode.Text);
