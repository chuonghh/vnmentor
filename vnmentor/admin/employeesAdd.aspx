<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="employeesAdd.aspx.cs" Inherits="admin_employeesAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <script type="text/javascript">
        function onUploadControlFileUploadComplete(s, e) {
            if(e.isValid)
                document.getElementById("uploadedImage").src = "/admin/images/uploadTemp/employees/" + e.callbackData;  
   ...
   <dx:ASPxTextBox ID="txt_BHYT" runat="server"  Width="120px"  Theme="Material"  CssClass="black_18_b" AutoPostBack="false" TabIndex="18"  >
    ...
    <div class="uploadContainer">
        <dx:ASPxUploadControl ID="UploadControl" ClientInstanceName="UploadControl" runat="server" UploadMode="Auto" AutoStartUpload="True" Width="100%" 
            ShowProgressPanel="True" DialogTriggerID="externalDropZone" OnFileUploadComplete="UploadControl_FileUploadComplete" Theme="Material" TabIndex="19" >
