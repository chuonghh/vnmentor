<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="employeesList.aspx.cs" Inherits="admin_employeesList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server"  UpdateMode="Conditional" ChildrenAsTriggers="false">
       ...
       <div class ="col-lg-12 margin-bottom"> 
         <div class="col-lg-8">
         <div class="col-lg-2 text-right pad-top-4">
 ...
 <dx:ASPxComboBox ID="cb_comCode" runat="server" Theme="Material" AutoPostBack="true"  EnableCallbackMode="true" CallbackPageSize="10"
         ...
         <Border BorderColor="#006600" BorderStyle="Solid" BorderWidth="1px" />
            ...
            <div class ="col-lg-12  margin-bottom"> 
                    <dx:ASPxButton ID="btn_export_xlsx" runat="server" Text="&nbsp; Export XLSX &nbsp;" Height="25px" Theme="Material" Width="140px"    AutoPostBack="true" OnClick="btn_export_Click" BackColor="#CBAB58"  >
        
                        <Image IconID="export_exporttoxlsx_svg_white_16x16">
                        </Image> 
    </dx:ASPxButton>
                  <dx:ASPxButton ID="btn_export_xls" runat="server" Text="&nbsp; Export XLS &nbsp;" Height="25px" Theme="Material" Width="140px"    AutoPostBack="true"  BackColor="#CBAB58" OnClick="btn_export_xls_Click"  >
        
                        <Image IconID="export_exporttoxls_svg_white_16x16">
                        </Image> 
    </dx:ASPxButton>
                 <dx:ASPxButton ID="btn_export_pdf" runat="server" Text="&nbsp; Export PDF &nbsp;" Height="25px" Theme="Material" Width="140px"    AutoPostBack="true"  BackColor="#CBAB58" OnClick="btn_export_pdf_Click"   >
        
                        <Image IconID="export_exporttopdf_svg_white_16x16">
                        </Image> 
    </dx:ASPxButton>
                </div>
    <div class ="col-lg-12"> 
   
          <dx:ASPxGridView ID="gv_list" KeyFieldName="empCode" runat="server" Theme="Material" AutoGenerateColumns="False" Width="100%" EnableTheming="True" OnDataBinding="gv_list_DataBinding"  > 
            ...
            <SettingsText EmptyDataRow="Hiện tại chưa có dữ liệu" />
            <Columns>
                  <dx:GridViewCommandColumn ShowSelectCheckbox="True" ShowClearFilterButton="true"  SelectAllCheckboxMode="Page"  VisibleIndex="0" Width="30px" >
                  <HeaderStyle BackColor="White" VerticalAlign="Middle" />
                   
                  </dx:GridViewCommandColumn>
                   <dx:GridViewDataButtonEditColumn Caption="" VisibleIndex="1"  Width="70px">
                    <DataItemTemplate> 
                                       <dx:ASPxButton ID="btn_update" runat="server" AutoPostBack="true" style="float: right" CssPostfix="Aqua" Image-Url="images/icon/edit-01.png" OnClick="btn_update_Click">
                                       </dx:ASPxButton> 
                                 
                                       <dx:ASPxButton ID="btn_popup_delete" runat="server" AutoPostBack="true"  style="float: left; margin-right: 5px" CssPostfix="Aqua" Image-Url="images/icon/delete.png" OnClick="btn_popup_delete_Click" ClientEnabled="true"  >
                                       </dx:ASPxButton>
                                   </div> 
                    </DataItemTemplate>
                </dx:GridViewDataButtonEditColumn> 

              <dx:GridViewDataTextColumn Caption="Mã NV" FieldName="empCode" VisibleIndex="2"  Width="70px" CellStyle-CssClass="text-black">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Tên nhân viên" FieldName="empName" VisibleIndex="3"  Width="150px">
                </dx:GridViewDataTextColumn>  
                   <dx:GridViewDataTextColumn Caption="Bộ Phận" FieldName="depName"  VisibleIndex="4"   Width="140px">
                </dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn Caption="Ngày sinh" FieldName="birthDay" VisibleIndex="5" Width="80px">
                </dx:GridViewDataDateColumn>
                  <%-- <dx:GridViewDataTextColumn Caption="Nơi sinh" FieldName="birthPlace" VisibleIndex="5"  Width="100px">
                </dx:GridViewDataTextColumn>--%>
                   <dx:GridViewDataTextColumn Caption="Hợp đồng" FieldName="contractYear" VisibleIndex="6"  Width="120px">
                </dx:GridViewDataTextColumn>
               <%--  <dx:GridViewDataTextColumn Caption="CMND" FieldName="identityCard" VisibleIndex="6"  Width="100px">
                </dx:GridViewDataTextColumn>--%>
                    <dx:GridViewDataTextColumn Caption="email" FieldName="email" VisibleIndex="7"  Width="100px">
                </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Điện thoại" FieldName="phone" VisibleIndex="8"  Width="100px">
                </dx:GridViewDataTextColumn> 
